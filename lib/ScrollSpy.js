    ...
    ScrollSpy.registerScrollSpy = function (maxRetries, retryInterval) {
        ...
        function scrollSpy() {
            ...
            for (var i = 0; i < ScrollSpy.scrollSpyIDs.length; ++i) {
                var spyElement = document.getElementById(ScrollSpy.scrollSpyIDs[i]);
            ...
            if ($$(window).scrollTop() + $$(window).height() >= $$(document).height() - 20) {
                $$(document.getElementById(ScrollSpy.scrollSpyDisplayIDs[ScrollSpy.scrollSpyDisplayIDs.length - 1])).addClass(activeClass());
            }
        }
        function affix() {
            if (!$scrollSpy)
